...
function ProjectCard({ project, index }: { project: typeof projects[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 hover:border-violet-500/30 transition-all duration-300 hover:bg-white/[0.05]">
        {/* Status badge */}
